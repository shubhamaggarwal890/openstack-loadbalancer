...
public class LoadBalancer {
    private static void startLoadBalancer(String schedAlgo) {
        try {
            ...
            ServerSocket balancerSocket = new ServerSocket(80);
            int currentWorker = -1;
            int i=0;
		...
		System.out.println(workers.get(currentWorker).getHost());
		System.out.println(workers.get(currentWorker).getPort());
